...
<li class="breadcrumb-item">Seller Centre</li>
@endsection
      ...
      <div class="file-sidebar">
        <div class="card">
          <div class="card-body">
            <ul>
              <li>
                <div class="btn btn-primary"><i data-feather="truck"></i>Delivery</div>
              </li>
              <li>
                <div class="btn btn-light"><i data-feather="file-text"></i>Order</div>
              </li>
              <li>
                <div class="btn btn-light"><i data-feather="package"></i>Product</div>
              </li>
              <li>
                <div class="btn btn-light"><i data-feather="tag"></i>My Promotions</div>
              </li>
              <li>
                <div class="btn btn-light"><i data-feather="dollar-sign"></i>Finance</div>
              </li>
              <li>
                <div class="btn btn-light"><i data-feather="database"></i>Data</div>
              </li>
              <li>
                <div class="btn btn-light"><i data-feather="award"></i>Seller Development</div>
              </li>
              <li>
                <div class="btn btn-light"><i data-feather="message-circle"></i>Buyer Service</div>
              </li>
              <li>
                <div class="btn btn-light"><i data-feather="shopping-bag"></i>Shop</div>
              </li>
              <li>
                <div class="btn btn-light"><i data-feather="settings"></i>Setting</div>
              </li>
              <li>
                <div class="btn btn-light"><i data-feather="help-circle"></i>Help</div>
              </li>
            </ul>
            <hr>
          </div>
